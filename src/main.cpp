...
uint256 hashGenesisBlock("0x26477876c7c4b50902db7dc12d2ad2223a035f94c66aaa61f64e401ed41e1deb");
...
const string strMessageMagic = "OccomCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // OccomCoin: 1 days
static const int64 nTargetSpacing = 120; // OccomCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal occomcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "OccomCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0f25b9545425d0d33d356ccf398d9175d4f97d797fdf40ae72abfc30f43e55a8");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Peter Thiel releases Zero to One";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 3603089;

        if (fTestNet)
        {
            block.nTime    = 1411210310;
            block.nNonce   = 1571210;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x0a409855a125688b2872f4bf5895231482bb7b514f1116195a72ab1649a15600"));
